<?php
require_once "../../helper/Funciones_Generales.php";

session_start();

if (!isset($_SESSION['is_logged']) && ($_SESSION['is_logged']  != true)) {
  $error = "El usuario no ha iniciado sesion...";
...
<body class="hold-transition sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="../../backend/panel/liberate_user.php" class="nav-link">Cerrar sesion</a>
        </li>
      </ul>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function(event) {
      ...
      //   echo mostrar_alerta($_SESSION["msg"]["type"],
      //   $_SESSION["msg"]["description"],
      //   $_SESSION["msg"]["title"]
      //   );
      // }
      ?>
